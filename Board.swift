...
class Board:NSObject {
    ...
    override var description: String {
        return "currentPayer: \(String(describing: currentPlayer))\n cueBall: \(String(describing: cueBall))\n remainingBalls: \(remainingBalls)\n"
    }
    ...
    func computeAngle(ball1: Ball, ball2: Ball) -> [(Int, distance:CGFloat)] {
        ...
        if dist == 2 * r {
            ...
            var ang1 = ang - CGFloat(Double.pi/4)
            var ang2 = ang + CGFloat(Double.pi/4)
            ...
            if ang2 - ang1 >= CGFloat(Double.pi) {
                let t = ang1
                ang1 = ang2
                ang2 = t + CGFloat(2 * Double.pi)
            }
    ...
    func validAngles() -> [(angle:CGFloat, distance:CGFloat)] {
        print("Computing valid angles for \(String(describing: currentPlayer))")
